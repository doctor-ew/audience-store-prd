...
**Acceptance Criteria**:
-   A custom icon (a soccer ball) for Mercedes-Benz Stadium appears on the map.
...
-   [ ] **Task 1**: Create a placeholder SVG icon for the stadium.
    -   **Action**: Create a new directory `public/assets`. Inside, create a new file named `stadium-icon.svg`. Add the following SVG code. It's a simple soccer ball to represent the stadium.
    ```xml
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="#FFFFFF" stroke="black" stroke-width="1.5">
      <circle cx="12" cy="12" r="10" />
      <path d="M12 2L12 6M12 18L12 22M6 12L2 12M22 12L18 12M18.36 5.64L15.5 8.5M8.5 15.5L5.64 18.36M18.36 18.36L15.5 15.5M8.5 8.5L5.64 5.64" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
    ```
